...
Last edited by/on: FAM 030319 1800
Description: analysing functions necessary for construction of staircase with map
understanding pick and place situation
"""
import rospy
import math
import numpy as np
...
global position # find out what this means
global ef_pos # find out what this means
...
def staircase_1(publishers, grip_pos, grip_pub): # not in use
    global ef_pos
    q1 = quaternion_from_euler(-3.141, 0, 2.35) # gripper facing downwards
