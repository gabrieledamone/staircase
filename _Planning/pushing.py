...
Description: pushing the bricks
"""
import rospy
import math
import numpy as np
...
def push(publishers, grip_pos, grip_pub): # picks up bring placed at x=0.4, y=0, z=0, roll, pitch, yaw=0
...
def joint_move_push(publishers, start_pos, end_pos):
...
if __name__ == '__main__':
    ...
    # sequence(arm_pubs)
    push(arm_pubs, grip_pos, grip_pub)
